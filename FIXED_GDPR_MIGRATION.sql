-- FIXED GDPR/CCPA Compliance Schema Migration
-- This version drops the existing incomplete dsar_requests table first
-- Then creates all tables with correct schema
...
-- Data Subject Access Requests (DSAR) - WITH user_id column
