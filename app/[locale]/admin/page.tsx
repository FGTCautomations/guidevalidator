      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-8">
        ...
        <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          <Link
            ...
            className="flex flex-col items-center justify-center gap-3 rounded-[var(--radius-xl)] border border-foreground/10 bg-white/80 p-6 shadow-sm transition hover:shadow-md hover:bg-white"
          >
            <svg
              aria-hidden="true"
            ...
            <span className="text-center text-sm font-semibold text-foreground">Search All Accounts</span>
          </Link>
          ...
          >
            ...
            <span className="text-center text-sm font-semibold text-foreground">Bulk Upload</span>
          </Link>

          <div className="flex flex-col items-center justify-center gap-3 rounded-[var(--radius-xl)] border border-foreground/10 bg-white/80 p-6 shadow-sm">
          ...
          >
            ...
            <span className="text-center text-sm font-semibold text-foreground">Verification</span>
          </Link>
          ...
          >
            ...
            <span className="text-center text-sm font-semibold text-foreground">Reviews</span>
          </Link>
          ...
          >
            ...
            <span className="text-center text-sm font-semibold text-foreground">Review Stats</span>
          </Link>
          ...
          >
            ...
            <span className="text-center text-sm font-semibold text-foreground">Ads Management</span>
          </Link>

          <Link
            href={`/${locale}/admin/applications`}
            className="relative flex flex-col items-center justify-center gap-3 rounded-[var(--radius-xl)] border border-foreground/10 bg-white/80 p-6 shadow-sm transition hover:shadow-md hover:bg-white"
            aria-label={
          ...
          >
            {pendingApplicationsCount > 0 && (
              <span
                aria-hidden="true"
                className="absolute right-2 top-2 inline-flex h-6 min-w-[1.5rem] items-center justify-center rounded-full bg-red-500 px-2 text-xs font-semibold text-white"
              >
            ...
            <span className="text-center text-sm font-semibold text-foreground">Applications</span>
          </Link>
          ...
          >
            ...
            <span className="text-center text-sm font-semibold text-foreground">Anti-Scraping</span>
          </Link>
        </section>
      </div>
    </div>
