// ============================================
// PASTE THIS VERSION IN SUPABASE DASHBOARD
// ============================================
// Guide Search Edge Function - Dashboard Version
// This version is optimized for copy-pasting into Supabase Dashboard
...
function validateSort(sort?: string): string {
  const allowed = ["featured", "rating", "price"];
...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    const params: SearchParams = {
      ...
      minRating:
        parseNumber(searchParams.get("minRating"), 0, 5) || undefined,
    ...
    const response = new Response(JSON.stringify(data), {
      ...
      headers: {
        ...
        "Cache-Control": params.cursor
          ? "public, max-age=60, s-maxage=60" // Paginated: 1 min cache
