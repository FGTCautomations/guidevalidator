...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    const params: SearchParams = {
      ...
      nicheFocus: searchParams.get("nicheFocus")?.split(",").filter(Boolean),
    ...
    const { data, error } = await supabase.rpc("api_agencies_search", {
      p_country: params.country || null,
      p_languages: params.lang || null,
      p_specialties: params.specialties || null,
      p_niche_focus: params.nicheFocus || null,
      p_q: params.q || null,
