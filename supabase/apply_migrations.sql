...
-- ============================================================================
-- PART 1: Review Stats Functions (20251005120000)
-- ============================================================================
...
-- ============================================================================
-- PART 2: GDPR/CCPA Compliance (20251006000000)
-- ============================================================================
...
DROP POLICY IF EXISTS "Users can create own DSAR requests" ON public.dsar_requests;
...
DROP POLICY IF EXISTS "Admins can update DSAR requests" ON public.dsar_requests;
...
DROP POLICY IF EXISTS "Admins can view archived accounts" ON public.archived_accounts;
...
DROP POLICY IF EXISTS "Admins can view GDPR audit log" ON public.gdpr_audit_log;
...
DROP TRIGGER IF EXISTS update_dsar_requests_updated_at ON public.dsar_requests;
...
-- MIGRATION COMPLETE
-- ============================================================================
-- This script has applied:
-- 1. Review stats functions (get_average_rating)
-- 2. GDPR/CCPA compliance schema (consents, DSAR, audit logging)
-- 3. Soft delete functionality for accounts
