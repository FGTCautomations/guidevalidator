    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <p className="text-xs text-foreground/60">
          Add all countries where you offer guide services
        </p>
        <div className="relative">
          ...
          {searchTerm && filteredCountries.length > 0 && (
            <div className="absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-lg border border-foreground/15 bg-white shadow-lg">
              {filteredCountries.map((country) => (
                <button
                  ...
                  className="w-full px-4 py-2 text-left text-sm hover:bg-primary/10 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  <span className="font-medium">{country.name}</span>
                  <span className="ml-2 text-xs text-foreground/60">({country.code})</span>
                </button>
              ))}
            </div>
          )}
            ...
            {expandedCountries.has(country.countryCode) && (
              <div className="p-4 space-y-4">
                <TagInput
                  ...
                  onAdd={(value) => handleAddTag(country.countryCode, 'regions', value)}
                ...
                <TagInput
                  ...
                  tags={country.cities}
                  onAdd={(value) => handleAddTag(country.countryCode, 'cities', value)}
                ...
                <TagInput
                  ...
                  tags={country.parks}
                  onAdd={(value) => handleAddTag(country.countryCode, 'parks', value)}
